...
import img from "../../assets/images/sertifikatArief.png";
...
export default class TeamDetailsContent extends Component {
  ...
  educations = {
    items: [
      {
        list:
          "Ahli Keselamatan dan Kesehatan Kerja, Disertifikasi oleh PT. Sucofindo",
      },
    ],
  };
  render() {
        ...
        <div className="container">
          <div className="team-details-grid-top d-grid">
            ...
            <div className="team-details-content">
              <h1 className="name">M. Arief Sastrawan, ST</h1>
